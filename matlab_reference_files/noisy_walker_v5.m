function [distance_travelled , summed_displacements, times_detached] = noisy_walker_v5(infile, eta, spring_constant, cirrus_force, detachment_length, P10, P01, iterations, verbose, stateVector)
